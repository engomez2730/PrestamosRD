...
var raya = document.querySelector('.fa-bars');
var rayaCerrado = document.querySelector('.fa-times');
var sidebar = document.querySelector('.content-sidebar');
var content = document.querySelector('.content-fullbar');
